...
import kr.hhplus.be.server.exception.SeatNotAvailableException;
import kr.hhplus.be.server.repository.ReservationJpaRepository;
import kr.hhplus.be.server.repository.SeatJpaRepository;
